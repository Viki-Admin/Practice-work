            ...
            <div class="main_wrapper">
               ...
               <? 
                ...
                <form method="POST"action="/list/add_list">
                    ...
                    $run_tesk_list=mysqli_query($this,$str_tesk_list);
                    $tesk_list_str=mysqli_num_rows($run_tesk_list);

                    while ($out_list = mysqli_fetch_array($run_tesk_list)) {
                        if($out_list['status'] == 1)
                        {
                            $status_btn="<a href='/list/status/?status_id=$out_list[id]'><input class='form_6' type='submit' name='sub_user' value=' UNREADY  '></a>";
                            $status_img="<div class= 'd1'></div>";
                        }
                        elseif($out_list['status'] == 2)
                        {
                            $status_btn="<a href='/list/status/?status_id=$out_list[id]'><input class='form_6' type='submit' name='sub_user' value=' READY  '></a>";
                        ...
                        echo"
                                ...
                                <div class= 'dis'>
                                    <div class = 'di'>
                                        ...
                                        <a href='/list/delete/?delete_id=$out_list[id]'><input class='form_6' type='submit' name='sub_user' value=' DELETE '></a>
