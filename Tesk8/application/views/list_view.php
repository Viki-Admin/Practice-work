...
?>
            <div class="main_wrapper">
                <form action="exit">
                    <input class="but" type="submit" value="Exit">
                </form>
                <div class="task">
                <div class="list">
               ...
               <? 
                ...
                <form method="POST"action="">
                    <input class='form_6' type='submit' name='sub_user' value=' REMOVE ALL '>
                    <input class="form_6" type="submit" name="sub_list" value=" READY ALL ">
                </form>
                    <hr>
